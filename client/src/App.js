...
function App() {
  ...
  const fetchFiles = async () => {
    try {
      const response = await axios.get('https://enotes2.vercel.app/files');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://enotes2.vercel.app/upload', formData, {
        headers: {
  ...
  const handleUpdate = async (id) => {
    ...
    try {
      await axios.put(`https://enotes2.vercel.app/update/${id}`, {
        title: updatedTitle,
  ...
  const handleDelete = async (id) => {
    try {
       await axios.delete(`https://enotes2.vercel.app/delete/${id}`);
